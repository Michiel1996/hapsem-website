...
/** Productiedomein — canonieke www-versie voor canonicals, sitemap en structured data */
export const SITE_URL = "https://www.huisartsenpraktijksemmerzake.be";
...
export const DR_LOICK_VANWETTER = {
  ...
  paragraphs: [
    "In 2021 behaalde ik mijn diploma Geneeskunde aan de Universiteit Gent. Daarna volgde ik mijn opleiding tot huisarts, zowel binnen HAPSEM bij dr. Lauwerier als in Gent. Sinds eind 2024 ben ik als vaste huisarts verbonden aan Huisartsenpraktijk Semmerzake.",
    "Wat mij zo aanspreekt in de huisartsgeneeskunde is de veelzijdigheid van het vak. Geen enkele dag is dezelfde, en ik krijg de kans om mensen te begeleiden in verschillende fases van hun leven. Net die combinatie van medische uitdaging en het opbouwen van een langdurige vertrouwensrelatie maakt voor mij huisartsgeneeskunde zo bijzonder.",
    "Ik vind het belangrijk om samen met patiënten naar een oplossing te zoeken die niet alleen medisch correct is, maar ook aansluit bij hun persoonlijke situatie en verwachtingen. Heldere communicatie, wederzijds vertrouwen en een persoonlijke aanpak vormen daarbij de basis. Ik wil een toegankelijk aanspreekpunt zijn voor al uw gezondheidsvragen, groot of klein.",
    "Mijn interesse strekt zich uit over de volledige breedte van de huisartsgeneeskunde. Daarbij heb ik bijzondere aandacht voor preventieve gezondheidszorg, leefstijlgerelateerde aandoeningen en het belang van een gezonde levensstijl. Ik geloof dat kleine, haalbare veranderingen vaak een grote impact kunnen hebben op gezondheid en welzijn op lange termijn.",
    "Naast mijn werk als huisarts ben ik een gepassioneerd sporter. Hockey maakt al sinds mijn jeugd een belangrijk deel uit van mijn leven. Na jarenlang op het hoogste clubniveau in België te hebben gespeeld, ben ik vandaag nog steeds actief bij Indiana De Pinte. De waarden die ik daar leerde — teamwork, discipline, engagement en respect — vormen ook in mijn werk als huisarts een belangrijke leidraad. Samen met mijn partner en onze twee kinderen geniet ik daarnaast van de kleine en grote momenten die het gezinsleven zo bijzonder maken.",
  ],
} as const;
